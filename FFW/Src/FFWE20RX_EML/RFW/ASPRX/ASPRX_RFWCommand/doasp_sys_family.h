...
#define RF_ASPFACT_SUPORT_RX 0x00000000000FFC0C		// RevRxE2No171004-001 Modify Line
// bit0		時間計測ch0				サポート
// bit1		時間計測ch1				サポート
...
extern BOOL IsSramFullStat_family(void);	// RevRxE2No171004-001 Modify Line
extern BOOL IsPwrMonCorrectValEna(void);
extern BOOL IsPwrMonCorrectThreasholdEna(void);
extern void Reset_Asp_family(void);			// RevRxE2No171004-001 Modify Line
...
extern int		GetDataN_H(DWORD dwSize, BYTE *const pbyReadData);
...
//	extern FFWERR PROT_BATEND_RecvErrCodeReservData(WORD wCmdCode);
	...
	extern void InitSramFullStopFlg(void);		// RevRxE2No171004-001 Modify Line
#ifdef __cplusplus
}
#endif

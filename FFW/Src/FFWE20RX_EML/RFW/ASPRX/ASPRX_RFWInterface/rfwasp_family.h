...
extern DWORD RFWASP_GetPowerMonitorDataRange_log_enter(DWORD *const pdwUAmin, DWORD *const pdwUAmax);
extern DWORD RFWASP_GetPowerMonitorDataRange_log_leave(DWORD *const pdwUAmin, DWORD *const pdwUAmax, DWORD dwRet);
